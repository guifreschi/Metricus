...
unit_list = ['newton', 'dyne', 'kilonewton', 'pound_force', 'ounce_force', 'ton_force', 'kilogram_force', 'gram_force', 'millinewton', 'poundal', 'slug_force']

def force_converter(force: float, from_unit: str, to_unit: str, with_unit: bool = False) -> Union[float, str]:
    """
