...
Usage Example:
    # Calculate the pressure from 100 pounds and 2 square feet, converting units to pascal
    result = calculate_pressure(100, 2, pressure_unit='pascal', force_unit='pound', area_unit='square_foot')
    print(result)  # Output: 4788.025

    # Calculate the pressure from 100 pounds and 2 square feet, with the result including the unit
    result = calculate_pressure(100, 2, pressure_unit='bar', force_unit='pound', area_unit='square_foot', with_unit=True)
